...
class RegisterScreen extends Component {
  ...
  handlePress = () => {
    ...
    this.props.createUser(_.omit(this.state, ['errors', 'passwordRepeat']))
      .then(response => {
...
export default connect(mapStateToProps, { createUser, saveCredentials, resetCredentials })(RegisterScreen);
