    ...
    return (
      <Card key={index} style={styles.cardContainer}>
        <CardHeader
         ...
         <Divider/>
          <CardActions>
            <RaisedButton onClick={bind(this.subscribeToTariff, this, tariff)}
                          backgroundColor={grey900} label={'Записать учеников'}
                          labelStyle={{color:'white'}}
                          style={{borderRadius:'20px'}}/>
            <RaisedButton onClick={bind(this.updateClick, this, tariff)}
                          backgroundColor={grey900} label={'Редактировать'}
                          labelStyle={{color:'white'}}
                          style={{borderRadius:'20px', marginTop: 12}}/>
            <RaisedButton onClick={bind(this.clickDeleteTariff, this, tariff)}
                          backgroundColor={grey900} label={'Удалить'}
                          labelStyle={{color:'white'}}
                          style={{borderRadius:'20px', marginTop: 12}}/>
        </CardActions>
      </Card>
...
export default connect(mapStateToProps, {loadTariffs, createTariff, updateTariff, deleteTariff})(withGetScreen(TariffScreen))
