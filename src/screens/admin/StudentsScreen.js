...
class StudentsScreen extends Component {
    ...
    onStudentAdded = studentObj => {
        ...
        this.props
            ...
            .catch(err => {
                ...
                this.setState({
                    openSnackbar: true,
                    messageSnackbar: 'Ваш тарифный план не позволяет добавлять новых учеников'
                })
            })
    }
    ...
    subscribeStudents = () => {
        ...
        this.props
            .subscribeStudents(tariffId, this.extractStudentIds(selectedRows))
            .then(() => {
...
export default connect(
    mapStateToProps,
    { loadStudents, addStudent, subscribeStudents }
)(StudentsScreen)
