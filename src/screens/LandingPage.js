    ...
    return(
      <div>
        ...
        <div>
          <Parallax
            blur={1}
            bgImage={'/static/images/back_parallax.jpg'}
            bgImageAlt="the cat"
            strength={200}
          >
            <Grid>
              <Row>
                <Col md={12}>
                  <h2 style={{textAlign:'center', fontFamily:'code', fontWeight:'bold', color:'white'}}>Более 98% репетиторов успешно окончили курс</h2>
                </Col>
              </Row>
              <Row>
                <Col md={12}>
              ...
              <Col md={12}>
                ...
                <FlatButton backgroundColor={'#03A9F4'} hoverColor={'#0197db'}
                            style={styles.loginButton}  href={'app/login'}>
