            ...
            <Paper elevation={1} className={classes.root}>
                <div className={classes.logosContainer}>
                    ...
                    <button className={classNames(classes.buttonStyle, { [classes.activeButtonStyle]: active.chart })}>
                        <Icon
                            className={classNames('far fa-chart-bar', classes.icon, {
                                [classes.activeIcon]: active.chart
                            })}
                        />
                    </button>
                    <button
                        className={classNames(classes.buttonStyle, { [classes.activeButtonStyle]: active.graduation })}
                    >
                        <Icon
                            className={classNames('fas fa-graduation-cap', classes.icon, {
                                [classes.activeIcon]: active.graduation
                            })}
                        />
                    </button>
                    <button
                        className={classNames(classes.buttonStyle, { [classes.activeButtonStyle]: active.accounts })}
                    >
                        <Icon
                            className={classNames('fas fa-book', classes.icon, {
                                [classes.activeIcon]: active.accounts
                            })}
                        />
                    </button>
                </div>
