    ...
    render() {
        ...
        return (
            ...
            >
                <div
                    style={{
                        border: `${borderDisplay}px solid #6AD9FD`,
                ...
                >
                    ...
                    {this.props.nastedThemes && (
                        <div>
                            {' '}
                            <p style={{ margin: '0px' }}>
                                Кол-во разделов:{' '}
                                <span style={{ fontWeight: 'bold' }}>
                                    <span style={{ fontWeight: 'bold' }}>{this.props.number}</span>
                                </span>
                            </p>
                            <p style={{ margin: '0px' }}>
                                Выполнено: <span style={inlineStyles.number}>{this.props.doneNumber}</span> из{' '}
                                <span style={{ fontWeight: 'bold' }}>{this.props.number}</span>
                            </p>
                        </div>
                    )}
