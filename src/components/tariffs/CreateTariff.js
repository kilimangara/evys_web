  ...
  render(){
    return (
      <div style={styles.container}>
        <TextField onChange={bind(this.textFieldChanged, this, 'name')}
          hintText="Название" value={this.state.name}
          underlineFocusStyle={{borderColor: grey900}} />
        <TextField onChange={bind(this.textFieldChanged, this, 'amount')}
          hintText="Стоимость" value={this.state.amount} type={'number'} inputStyle={{step:'any'}}
          underlineFocusStyle={{borderColor: grey900}} />
        <TextField onChange={bind(this.textFieldChanged, this, 'description')}
          hintText="Описание" value={this.state.description}
          underlineFocusStyle={{borderColor: grey900}} />
        <TextField onChange={bind(this.textFieldChanged, this, 'description_private')}
          hintText="Скрытое описание" value={this.state.description_private}
          underlineFocusStyle={{borderColor: grey900}} />
